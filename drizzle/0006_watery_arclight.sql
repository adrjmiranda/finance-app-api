CREATE VIEW "public"."transactions_balance_view" AS (
    SELECT 
      ...
      SUM(CASE WHEN "transactions"."type" = 'investment' THEN "transactions"."amount" ELSE 0 END) as investiments,
      SUM(CASE WHEN "transactions"."type" = 'earning' THEN "transactions"."amount" ELSE -"transactions"."amount" END) as balances
    FROM "transactions"
